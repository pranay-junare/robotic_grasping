...
//void move_servo_gripper(int gripper_width_mm);
//int read_Serialterminal(void);
...
void move_servo_home(void){
    int speed_ser = 5;
    move_servo_speed(0,90,speed_ser);
    delay(2000);
    
    move_servo_speed(1,110,speed_ser);
    move_servo_speed(2,120,speed_ser);
    move_servo_speed(3,130,speed_ser);
    move_servo_speed(4,90,speed_ser);
...
void Test_motion_00(void){
    ...
    move_servo_speed(1,30,speed_ser);
    move_servo_speed(2,30,speed_ser);
    move_servo_speed(3,30,speed_ser);
    move_servo_speed(4,30,speed_ser);
    delay(4000);
    
    move_servo_speed(0,20,speed_ser);
    delay(2000);
    
    move_servo_speed(1,80,speed_ser);
    move_servo_speed(2,80,speed_ser);
    move_servo_speed(3,80,speed_ser);
    move_servo_speed(4,80,speed_ser);
    delay(4000);
...
void servo_calibrate(int servo_num, int servo_speed){
  ...
  val = val_str.toInt();
    ...
    Serial.println(val);
    move_servo_speed(servo_num ,val ,servo_speed ); //servo_speed = 5
...
void servo_calibrate_raw(int servo_num, int servo_speed){
     //snippet to calibrate individual motor from serial monitor
  Serial.print("Enter the Value:  ");
